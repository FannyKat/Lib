...
FLAGS	=		-Wall -Wextra -I. -c

SRCS	=		ft_memset.c ft_bzero.c ft_memcpy.c ft_memccpy.c ft_memchr.c ft_strlen.c\
			...
			ft_lstadd.c ft_lstiter.c ft_lstmap.c ft_memmove.c ft_memcmp.c ft_isblank.c\
			ft_isspace.c ft_strrev.c ft_range.c ft_swap.c get_next_line.c ft_xlstadd.c\
			ft_strtolower.c my_printf.c function.c realloc_tab.c ft_tabfree.c ft_tabcopy.c\
			print_tab.c ft_split.c ft_strstart.c\
